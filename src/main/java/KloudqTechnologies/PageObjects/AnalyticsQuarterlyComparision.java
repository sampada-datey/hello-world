...
public class AnalyticsQuarterlyComparision extends AbstractComponent {

	public AnalyticsQuarterlyComparision(WebDriver driver) {
		super(driver);
	...
	{		
		String url = "https://shield.tor-iot.com/tor-lenz/energy/energy-reports/quarterly-comparision";
		driver.get(url);		      
		// get the current URL
	...
	public void ClickAQCReport() 
	{		
		WebElement clickAQCReport=driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[2]/div/div/div[4]/div/div/div[38]/div/a/a"));
		clickAQCReport.click();
	...
	{		
		...
		WebElement chkcompare=driver.findElement(By.xpath("//*[@id=\"flexCheckDefault\"]"));
		chkcompare.click();
		...
		logger=report1.createTest("Check Equipment Function-> Analytics Quarterly Comparison Data Table ");
		logger.info("Analytics Quarterly Comparison Visibility Test");
		...
		if(historytable.isDisplayed()) {
			System.out.println("Quarterly Comparison Report Data Table is visible");
			logger.log(Status.PASS,"Analytics Quarterly Comparison Report Data Table is visible in Daily function");
		}else {


			System.out.println("Analytics Quarterly Comparison Table is not visible");
			
			String screenshotPath=ErrorScreenshot(driver, historytable);
			logger.log(Status.FAIL,logger.addScreenCaptureFromPath(screenshotPath)+"     Error!    Analytics Quarterly Comparison Report Data Table is not visible in Daily function");
		...
		{		
			...
			logger=report2.createTest("Check Division Function-> Analytics Quarterly Comparison Data Table ");
			logger.info("Quarterly Comparison Report Test");
			logger.pass("Visibility Test Success");
			...
			}else 
			{
				...
				System.out.println("Quarterly Comparison Report Data Table is not visible");
		...
		public void Export(ExtentReports report3) throws InterruptedException
		{
			...
			String downloadedFileName = "Quarterly Comparision Report.xlsx";
			boolean isFileDownloaded = isFileDownloaded(downloadedFileName);


			if (isFileDownloaded) {
				System.out.println("File downloaded successfully.");
				logger.log(Status.PASS,"Analytics Quarterly Comparison Export function file is downloaded successfully");
				// You can add further processing here if needed
			} else {
				System.out.println("File download failed.");
				logger.log(Status.FAIL,"Error! Analytics Quarterly Comparison Export function file is not downloaded successfully");
			}
